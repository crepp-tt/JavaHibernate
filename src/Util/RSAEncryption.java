...
public class RSAEncryption {
	...
	public String encrypt(String msg, PrivateKey key)
		...
		this.cipher.init(Cipher.ENCRYPT_MODE, key);
                byte[] cipherTextBytes = cipher.doFinal(msg.getBytes("UTF-8"));
	...
	public String decrypt(String msg, PublicKey key)
		...
		this.cipher.init(Cipher.DECRYPT_MODE, key);
                byte[] decryptedCipherTextBytes = cipher.doFinal(Base64.getDecoder().decode(msg));
		String decryptedCipherText = new String(decryptedCipherTextBytes,"UTF-8");
